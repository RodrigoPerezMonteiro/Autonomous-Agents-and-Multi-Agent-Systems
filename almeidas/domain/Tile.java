...
public class Tile {
    ...
    public void render(Graphics2D g) {
        ...
        if (x == 0 && y == 0) {
            ...
            g.drawString("" + this.getValue(), BoardPanel.SQUARE_SIZE * x + 33, BoardPanel.SQUARE_SIZE * y + 48);
        ...
        // Comment/Uncomment when debugging (show tile position on board)

        /*g.setFont(new Font("default", Font.ITALIC, 9));
        g.setColor(Color.DARK_GRAY);
        g.drawString(this.x + ", " + this.y, BoardPanel.SQUARE_SIZE * x + 3, BoardPanel.SQUARE_SIZE * y + 30);*/
    }
}
